...
export const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/my-tests", icon: ClipboardCheck, label: "Bài kiểm tra", roles: STUDENT },
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/admin/tests", icon: ClipboardCheck, label: "Bài kiểm tra", roles: STAFF },
      ...
      { href: "/admin/exam-blueprints", icon: FileText, label: "Tạo đề theo khung đề", roles: LEAD, needsCreate: "blueprint" },
